!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        ...
        this.$modal.find('form').unbind('submit').on('submit', function(){
            ...
            if(title) {
                ...
                $.post(APP.SERVER_PATH+'add-event.php', {event: newEvent}).then(function(id){
                    newEvent.id = id;
    ...
    CalendarApp.prototype.updateEvent =  function (calEvent, revertFunc) {
        ...
        var $this = this;
            ...
            $this.$eventModal.find('#deleteEventButton').unbind('click').click(function(){
                ...
                $.post(APP.SERVER_PATH+'remove-event.php',{id: calEvent.id}).then(function(data){
                    // Remove Event
            ...
            $this.$eventModal.find('form').unbind('submit').on('submit', function () {
                if($(this).find("#event-title").val()) {
                    ...
                    $.post(APP.SERVER_PATH+'update-event.php', {event: event}).then(function(){
                        // update event
    ...
    CalendarApp.prototype.onDrop = function (eventObj, date) { 
        ...
        // execute the query to save the event in the database and get its id
        $.post(APP.SERVER_PATH+'add-event.php', {event: copiedEventObject}).then(function(id){
    ...
    CalendarApp.prototype.init = function() {
        ...
        $this.$calendarObj = $this.$calendar.fullCalendar({
            ...
            events: APP.SERVER_PATH+'events.php',
            editable: true,
